                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myAreaChart" width="962" height="384" style="display: block; width: 481px; height: 192px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="962" height="384" class="chartjs-render-monitor" style="display: block; width: 481px; height: 192px;"></canvas></div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><label><select class="dataTable-selector"><option value="5">5</option><option value="10" selected="">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select> entries per page</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div></div><div class="dataTable-container"><table id="datatablesSimple" class="dataTable-table">
                                    <thead>
                                        <tr><th data-sortable="" style="width: 19.5609%;"><a href="#" class="dataTable-sorter">Name</a></th><th data-sortable="" style="width: 28.9421%;"><a href="#" class="dataTable-sorter">Position</a></th><th data-sortable="" style="width: 15.6687%;"><a href="#" class="dataTable-sorter">Office</a></th><th data-sortable="" style="width: 9.18164%;"><a href="#" class="dataTable-sorter">Age</a></th><th data-sortable="" style="width: 15.1697%;"><a href="#" class="dataTable-sorter">Start date</a></th><th data-sortable="" style="width: 11.477%;"><a href="#" class="dataTable-sorter">Salary</a></th></tr>
                                    </thead>
